...
export class LearnPage {
  myForm: FormGroup; maxValue = 6; progressval = 0;
  answerInput: ''; answer: ''; word = ''; correct = 0;
  error = 0; i = 0; arrayLength = 0;
  ...
  onSubmit() {
    ...
    this.progressval++ /*propress bar value*/
    this.i++
    this.i < this.arrayLength ? this.setValue() : this.notification()
  }
  // switch to new page
  notification() {
    let modal = this.modalCtrl.create(NotificationPage, { "correct": this.correct, "fromPage": "learn" });
    modal.present();
    this.navCtrl.pop();
  }
}